...
# ===================================================================
# FUNGSI CREATE ACCESS TOKEN & CREATE REFRESH TOKEN
# ===================================================================
...
def create_access_token(data: dict, expires_delta: Optional[timedelta] = None):
    ...
    if expires_delta:
        ...
        # Default ke umur pendek jika tidak ditentukan
...
def create_reset_token(data: dict, expires_delta: Optional[timedelta] = None):
    ...
    to_encode.update({"exp": expire, "token_type": "reset"}) # Tandai sebagai token "reset"
    encoded_jwt = jwt.encode(to_encode, SECRET_KEY, algorithm=ALGORITHM)
    return encoded_jwt
